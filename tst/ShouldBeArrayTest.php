...
class ShouldBeArrayTest extends TestCase
{
    public function test_should_be_array(): void
    {
        $constraint = shouldBeArray();
        pipe($constraint->toString())->to(shouldBe('is of type array'));
