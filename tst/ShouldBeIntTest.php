...
class ShouldBeIntTest extends TestCase
{
    public function test_should_be_int(): void
    {
        $constraint = shouldBeInt();
        pipe($constraint->toString())->to(shouldBe('is of type int'));
