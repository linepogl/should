...
use function Should\shouldBeFloat;
use function Should\shouldBeInt;
use function Should\shouldNotThrow;
use function Should\shouldThrow;

class ShouldBeFloatTest extends TestCase
{
    public function test_should_be_float(): void
    {
        $constraint = shouldBeFloat();
        pipe($constraint->toString())->to(shouldBe('is of type float'));
